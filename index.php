        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                           <?php the_field('history_slide_title') ?>
                        </div>
                        <div class="aboutus__text">
                                    <?php the_field('history_slide_descr') ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="subtitle">
                             <?php the_field('history_slide_title_second') ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('history_slide_descr_second') ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
							<?php the_field('history_slide_title_three') ?>
                        </div>
                        <div class="aboutus__text">
							<?php the_field('history_slide_descr_three') ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row">
                            ...
                            <div class="contacts__phones">
                                ...
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('phone_second') ?>"><?php the_field('phone_second') ?></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
						...
						<div class="contacts__feed">
                       		<?php echo do_shortcode('[contact-form-7 id="e1987f9" title="Форма отзывов"]'); ?>
						</div>
                    </div>
                </div>
                <div class="row mt70">
